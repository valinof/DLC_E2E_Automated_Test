Feature: Links on the Home Page
  ...
  Scenario Outline: Addition Links - Verify Correct Navigation
    ...
    And I navigate to the "https://dontbebroke.com" url
    ...
    Examples:
      ...
      | Work At DLC | https://dontbebroke.isolvedhire.com/pages/jobsbylocation/ | Jobs by Location |
